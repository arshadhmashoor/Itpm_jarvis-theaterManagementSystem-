    ...
    public partial class adminlogin : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from admin_tb WHERE admin_id='" + TextBox1.Text.Trim() + "'AND password='" + TextBox2.Text.Trim() + "';", con);
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        Session["cusname"] = dr.GetValue(2).ToString();
                        Session["role"] = "admin";
